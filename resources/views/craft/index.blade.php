...
<head>
    ...
    <!-- Theme Style -->
    <link rel="stylesheet" href="{{ asset('craft-css/style.css') }}">
...
<body>
        ...
        <div class="container">
            <div class="row slider-text align-items-center justify-content-center">
                <div class="col-lg-9 text-center col-sm-12 element-animate">
                    <h1 class="mb-4">We Are Creative Agency</h1>
        ...
        <div class="container">
            ...
            <div class="nonloop-block-11 owl-carousel">
                <div class="item">
                    <div class="block-33 h-100">
                        <div class="vcard d-flex mb-3">
                            <div class="image align-self-center"><img src="{{ asset('craft-images/person_1.jpg') }}" alt="Person here"></div>
                        ...
                        <div class="text">
                            <blockquote>
                                <p>&rdquo; Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat qui, ipsum debitis id reprehenderit ut soluta possimus consectetur asperiores totam veniam quasi molestiae. Animi doloribus accusamus eius ex laudantium vitae? &ldquo;</p>
                            </blockquote>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="block-33 h-100">
                        <div class="vcard d-flex mb-3">
                            <div class="image align-self-center"><img src="{{ asset('craft-images/person_2.jpg') }}" alt="Person here"></div>
                            <div class="name-text align-self-center">
                        ...
                        <div class="text">
                            <blockquote>
                                <p>&rdquo; Lorem, ipsum dolor sit amet consectetur adipisicing elit. At, ut enim error molestias maxime deserunt voluptate doloribus nihil nesciunt id perferendis, doloremque earum architecto ab incidunt sunt corrupti. Consequuntur qui ullam voluptates sapiente quod esse eum. &ldquo;</p>
                            </blockquote>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="block-33 h-100">
                        ...
                        <div class="text">
                            <blockquote>
                                <p>&rdquo; Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur, ab? Asperiores dolore blanditiis quis sapiente soluta aliquid officiis. &ldquo;</p>
                            </blockquote>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="block-33 h-100">
                        ...
                        <div class="text">
                            <blockquote>
                                <p>&rdquo; Lorem ipsum dolor sit amet, consectetur adipisicing elit. At, accusamus? Porro fugit culpa consequuntur dolorum. &ldquo;</p>
                            </blockquote>
                        </div>
                    </div>
                </div>
        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    ...
                    <p class="text-white mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab dolorem voluptas soluta quo, odio quaerat.
                    </p>
            ...
            <div class="row">
                <div class="col-12 text-md-center text-left">
                    <p>
                        ...
                        <i class="fa fa-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
                </div>
            </div>
    ...
    <script src="{{ asset('craft-js/jquery-3.2.1.min.js') }}"></script>
    <script src="{{ asset('craft-js/jquery-migrate-3.0.1.min.js') }}"></script>
    <script src="{{ asset('craft-js/popper.min.js') }}"></script>
    <script src="{{ asset('craft-js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('craft-js/owl.carousel.min.js') }}"></script>
